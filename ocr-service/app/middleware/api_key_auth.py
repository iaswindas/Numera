...
only authorized services (the Kotlin backend) can call OCR endpoints.
"""
...
logger = logging.getLogger("ocr-service.middleware.auth")

# Paths that don't require authentication
PUBLIC_PATHS = frozenset({"/api/ocr/health", "/docs", "/openapi.json", "/redoc"})
